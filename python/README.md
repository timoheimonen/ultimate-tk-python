...
- Section 4 input/player control includes movement/collision/camera/weapon switching, shoot-reload cadence, and first-pass bi-directional combat (enemy spawn/aim/move/shoot + travel-time enemy projectiles + destructible/collectible crates with rewards + first-pass weapon ammo consumption/caps + ammo runtime telemetry snapshots for current weapon and full ammo pools + player/enemy damage tracking + game-over flow).
