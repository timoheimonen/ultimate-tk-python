...
- Next focus is Phase 6 Workstream 5 (regression expansion and lock criteria) to harden full menu -> progression -> menu loops while keeping Phase 5 combat/entity invariants stable.
