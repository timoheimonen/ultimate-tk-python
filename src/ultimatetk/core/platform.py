...
def _log_runtime_status(
    ...
    *,
    ...
    context.logger.info(
        ...
        context.runtime.progression_event if context.runtime.progression_event else "-",
        context.runtime.progression_from_level_index,
        context.runtime.progression_to_level_index,
        context.runtime.progression_has_next_level,
        context.runtime.progression_ticks_remaining,
